...
{
    [SessionFilter]
    public class EPCProgressManageController : Controller
    {//工程管理 - 進度管理
        ...
        {
            List<EPCSupDailyDate1VModel> supDailyDateList = supDailyReportService.GetSupDailyDateAndCount<EPCSupDailyDate1VModel>(id);
            if (supDailyDateList.Count != 1)
            {
                return Json(new
                {
