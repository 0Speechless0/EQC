...
<script>
    export default {
        ...
        methods: {
            ...
            getEngMain() {
                this.engMain = {};
                window.myAjax.post('/ECPriceAdjustment/GetEngItem', { id: this.tenderItem.Seq })
                    .then(resp => {
            ...
            updateAwardDate() {
                ...
                window.myAjax.post('/ECPriceAdjustment/UpdateEngAwardDate', { engMain: this.engMain })
                    .then(resp => {
                        if (resp.data.result == 0) {
                            this.getEngMain();
            ...
            saveMidKind() {
                ...
                window.myAjax.post('/ECPriceAdjustment/SaveMidKind', { items: this.midKinds })
                    .then(resp => {
                        if (resp.data.result == 0) {
            ...
            onCalPriceIndexClick() {
                ...
                window.myAjax.post('/ECPriceAdjustment/CalPriceIndex', { id: this.tenderItem.Seq, tarDate: this.activeItem.AdjMonthStr })
                    .then(resp => {
                        if (resp.data.result == 0) {
            ...
            onChangeDate(item) {
                ...
                this.itemGroup = null;
                window.myAjax.post('/ECPriceAdjustment/GetList', { id: this.tenderItem.Seq, tarDate: item.AdjMonthStr })
                    .then(resp => {
                        if (resp.data.result == 0) {
            ...
            getDateList() {
                this.dateList = [];
                window.myAjax.post('/ECPriceAdjustment/GetDateList', { id: this.tenderItem.Seq })
                    .then(resp => {
                        if (resp.data.result == 0) {
            ...
            //工程變更
            onEngChangeClick() {
                window.myAjax.post('/ECPriceAdjustment/CheckEngChangeDate', { id: this.tenderItem.Seq })
                    .then(resp => {
                        if (resp.data.result == 0) {
                            this.$swal({
                                title: '工程變更, 是否確定?',
            ...
            execChangeConfirm(result) {
                ...
                window.myAjax.post('/ECPriceAdjustment/ExecEngChangeDate', { id: this.tenderItem.Seq })
                    .then(resp => {
                        if (resp.data.result == 0) {
                            this.getDateList();
                        }
