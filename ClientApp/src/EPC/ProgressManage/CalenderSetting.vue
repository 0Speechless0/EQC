    ...
    <div>
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-4">
                ...
                <div class="mb-3">
                    <button v-on:click="onWorkModalOpen()" type="button" class="btn btn-color11-4 btn-sm mb-1" data-toggle="modal" data-target="#date_stopAndstart">設定停工 / 復工</button>
                    <button v-on:click="onExtensionModalOpen()" type="button" class="btn btn-color11-4 btn-sm mb-1" data-toggle="modal" data-target="#date_extend">設定展延工期</button><br>
                    ...
                    <div class="modal-body">
                            ...
                            <table class="table table-hover table2">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-inline">
                                                <input v-model="reportWork.SStopWorkDateStr" type="date" class="form-control my-1 mr-0 mr-sm-1">&nbsp;~&nbsp;
                                                <input v-model="reportWork.EStopWorkDateStr" type="date" class="form-control my-1">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>停工原因</th>
                                        <td>
                                            <textarea v-model="reportWork.StopWorkReason" rows="5" class="form-control"></textarea>
                                    ...
                                    <tr>
                                        <th>停工文號</th>
                                        <td>
                                            <input v-model="reportWork.StopWorkNo" type="text" class="form-control" value="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>核定公文檔案</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-inline">
                                                <input v-model="reportWork.BackWorkDateStr" type="date" class="form-control my-1 mr-0 mr-sm-1">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>復工文號</th>
                                        <td>
                                            <input v-model="reportWork.BackWorkNo" type="text" class="form-control" value="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>核定公文檔案</th>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-sm-4 col-xl-2 my-2">
                                <button v-on:click.stop="onWorkSave" role="button" class="btn btn-shadow btn-block btn-color11-3"> {{reportWork.Seq == -1 ? '新增':'儲存'}} <i class="fas fa-save fa-lg"></i></button>
                            </div>
                            <div class="col-12 col-sm-4 col-xl-2 my-2">
                            ...
                            <table class="table table-hover table2">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>公文核准文號</th>
                                        <td>
                                            <input v-model="reportExtension.ApprovalNo" type="text" class="form-control" value="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>公文核准日期</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input v-model="reportExtension.ExtendReasonOther" type="text" class="form-control" value="">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-responsive-md table-hover">
                                <thead class="insearch">
                                    <tr>
                                        ...
                                        <th><strong>公文核准文號</strong></th>
                                        <th><strong>公文核准日期</strong></th>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in extensionItems" v-bind:key="item.Seq" >
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <a v-on:click.stop="onExtensionDel(item)" href="javascript:void(0)" class="a-delete m-1" title="刪除"><i class="fas fa-trash-alt"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
    ...
    export default {
        ...
        methods: {
            ...
            onDownload(item, mode) {
                ...
                window.myAjax.get('/EPCProgressManage/DocDownload?id=' + this.tenderItem.Seq + "&fn=" + fName, { responseType: 'blob' })
                    .then(resp => {
            ...
            onWorkSave() {
                ...
                files.append("PrjXMLSeq", this.tenderItem.Seq);
            ...
            onExtensionAdd() {
                ...
                this.reportExtension.PrjXMLSeq = this.tenderItem.Seq;
            ...
            initReportExtension() {
                this.reportExtension = { Seq: -1, PrjXMLSeq: -1, ExtendDays: null, ApprovalNo: '', ApprovalDate: null, ExtendReason: null, ExtendReasonOther: ''};
            },
            ...
            onNoDurationAdd() {
                ...
                this.reportNoDuration.PrjXMLSeq = this.tenderItem.Seq;
            ...
            initReportNoDuration() {
                this.reportNoDuration = { Seq: -1, PrjXMLSeq: -1, StartDate: null, EndDate: null, DaySet: 1, Descript: '' };
            },
            ...
            onHolidayAdd() {
                ...
                this.reportHoliday.PrjXMLSeq = this.tenderItem.Seq;
            ...
            initReportHoliday() {
                this.reportHoliday = { Seq: -1, PrjXMLSeq: -1, StartDate: null, EndDate: null, DaySet: 2, Descript: '' };
            },
            onHolidayModalOpen() {
                this.getHolidayList();
            },
