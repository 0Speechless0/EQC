                    ...
                    <option v-for="option in towns" v-bind:value="option.Value" v-bind:key="option.Value">
                     ...
                     <div class="form-row">
                         <div class="col form-inline my-2">
                             ...
                             <div class="custom-control custom-radio mx-2">
                                 <input v-model="engMain.ExecType" @change="onExecTypeChange()" value="1" type="radio" id="self" class="custom-control-input" name="S/C">
                                 <label class="custom-control-label" for="self">自辦</label>
                             </div>
                             <div class="custom-control custom-radio mx-2">
                                 <input v-model="engMain.ExecType" @change="onExecTypeChange()" value="2" type="radio" id="commission" class="custom-control-input" name="S/C">
                     ...
                     <div class="form-row">
                         ...
                         <div class="col-12 col-md-6 form-inline my-2 justify-content-md-between">
                             ...
                             <b-input-group>
                                 <input v-model="engMain.DesignUnitEmail" @change="onChangeDesignUnit" type="text" class="form-control mydatewidth" placeholder="尚未輸入">
                             ...
                             <label class="my-2 mx-2">(資料儲存完後，點擊發送帳號通知Mail)</label>
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="col-12 col-md-6 form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">核定文號</label>
                             <input v-model.trim="engMain.ApproveNo" type="text" class="form-control my-1 mr-0 mr-md-4" placeholder="尚未輸入">
                         </div>
                         <div class="col-12 col-md-6 form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">核定日期</label>
                     ...
                     <div class="form-row">
                         <div class="col-12 col-md-6 form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">工程期限(天)</label>
                     ...
                     <div class="form-row">
                         ...
                         <div class="col-12 col-md-6 form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">聯絡人mail</label>
                             <b-input-group>
                                 <input v-model="engMain.BuildContractorEmail" @change="onChangeBuildContractor" type="text" class="form-control mydatewidth" placeholder="尚未輸入">
                     ...
                     <div class="form-row">
                         <div class="col-12 col-md-6 form-inline my-2 justify-content-md-between">
                             ...
                             <input v-model.trim="engMain.ConstructionDirector" type="text" class="form-control my-1 mr-0 mr-md-4" placeholder="尚未輸入">
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="col form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">工地現場人員1</label>
                             <input v-model.trim="engMain.ConstructionPerson1" type="text" class="form-control col-12 col-md-7 mx-0 mx-md-2" placeholder="尚未輸入">
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="col form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">工地現場人員2</label>
                             <input v-model.trim="engMain.ConstructionPerson2" type="text" class="form-control col-12 col-md-7 mx-0 mx-md-2" placeholder="尚未輸入">
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="col form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">現場人員3-品管</label>
                             <input v-model.trim="engMain.SupervisorCommPerson1" type="text" class="form-control col-12 col-md-7 mx-0 mx-md-2" placeholder="尚未輸入">
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="col form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">現場人員4-職安</label>
                             <input v-model.trim="engMain.SupervisorCommPerson3" type="text" class="form-control col-12 col-md-7 mx-0 mx-md-2" placeholder="尚未輸入">
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="col form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">現場人員5-土建及機電</label>
                             <input v-model.trim="engMain.SupervisorCommPerson2" type="text" class="form-control col-12 col-md-7 mx-0 mx-md-2" placeholder="尚未輸入">
                         </div>
                     </div>
                 </div>
                 <hr class="my-5">
                 ...
                 <div>
                     <div class="form-row">
                         <div class="col form-inline my-2">
                             <label class="my-2 mx-2">自辦/委辦</label>
                             <div class="custom-control custom-radio mx-2">
                                 <input v-model="engMain.SupervisorExecType" @change="onSupervisorExecTypeChange()" value="1" type="radio" id="Supervisor-self" class="custom-control-input" name="S/C">
                                 <label class="custom-control-label" for="Supervisor-self">自辦</label>
                             </div>
                             <div class="custom-control custom-radio mx-2">
                                 <input v-model="engMain.SupervisorExecType" @change="onSupervisorExecTypeChange()" value="2" type="radio" id="Supervisor-commission" class="custom-control-input" name="S/C">
                     ...
                     <div class="form-row">
                         ...
                         <div class="col-12 col-md-6 form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">聯絡人mail</label>
                             <b-input-group>
                                 <input v-model.trim="engMain.SupervisorContact" @change="onChangeSupervisorUnit" type="text" class="form-control mydatewidth" placeholder="尚未輸入">
                     ...
                     <div class="form-row">
                         <div class="col-12 col-md-6 form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">監造技師</label>
                             <input v-model.trim="engMain.SupervisorTechnician" type="text" class="form-control my-1 mr-0 mr-md-4" placeholder="尚未輸入">
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="col form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">現場人員1</label>
                             <input v-model.trim="engMain.SupervisorSelfPerson1" type="text" class="form-control col-12 col-md-8 mx-0 mx-md-2" placeholder="尚未輸入">
                         </div>
                     </div>
                     <div class="form-row">
                         <div class="col form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">現場人員2</label>
                             <input v-model.trim="engMain.SupervisorSelfPerson2" type="text" class="form-control col-12 col-md-8 mx-0 mx-md-2" placeholder="尚未輸入">
                         </div>
                     </div>

                 </div>
                 <div class="row justify-content-center mt-5">
                         <button v-on:click.stop="updateData()" v-bind:disabled="!fCanEdit" role="button" class="btn btn-color11-4 btn-xs mx-1" >
                             <i class="fas fa-save"> 儲存</i>
                         </button>
                     <!--
                     <div class="col-12 col-sm-5 col-lg-4 col-xl-3 mt-3">
                         <button v-on:click.stop="createSupervisionProject()" v-bind:disabled="!saveFlag || engMain.DocState!=null" role="button" class="btn btn-shadow btn-block my-3" v-bind:class="(saveFlag && engMain.DocState==null) ? 'btn-color2' : 'btn-color3'">
                             匯入標案基本資料
                         </button>
                     </div>
                     <div class="col-12 col-sm-4 col-xl-2 mt-3">
        ...
        methods: {
            ...
            updateData() {
                if (this.engMain.EngName == null || this.engMain.EngName.length == 0
                    ...
                    || this.engMain.OrganizerUnitSeq == null || this.engMain.OrganizerSubUnitSeq == null || this.engMain.OrganizerUserSeq == null
                ...
                if (this.engMain.BuildContractorTaxId.length==0 || !this.checkCompanyNo(this.engMain.BuildContractorTaxId)) {
                    alert('施工廠商統編錯誤');
                    return;
                }
                ...
                if (this.engMain.SupervisorTaxid.length > 0 && !this.checkCompanyNo(this.engMain.SupervisorTaxid)) {
                    alert('監造單位統編錯誤');
                    return;
                }
                ...
                if (this.engMain.DesignUnitTaxId.length > 0 && !this.checkCompanyNo(this.engMain.DesignUnitTaxId)) {
                    alert('設計單位統編錯誤');
                    return;
                }
