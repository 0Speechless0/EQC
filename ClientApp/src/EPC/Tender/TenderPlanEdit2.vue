     ...
     <div>
             <div style="width:800px">
                 ...
                 <div>
                     ...
                     <div class="form-row">
                         <div class="col form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">現場人員3-品管及職安</label>
                     ...
                     <div class="form-row">
                         <div class="col form-inline my-2 justify-content-md-between">
                             <label class="my-2 mx-2">現場人員4-土建及機電</label>
                             <input v-model.trim="engMain.SupervisorCommPersion2" type="text" class="form-control col-12 col-md-7 mx-0 mx-md-2" placeholder="尚未輸入">
                         </div>
                     </div>
                 </div>
                 <hr class="my-5">
