...
<script>
    import { Builder } from '../Backend/RiskManagement/gojs/Builder';
    import { ImageBuilder } from '../Backend/RiskManagement/gojs/ImageBuilder';
    ...
    export default {
        ...
        methods: {
            ...
            importDestructionJson(evt) {
                console.log(this.subProject.SubProjectName);
            ...
            async importDestruction(normal) {
                ...
                var jsonStr = (await window.myAjax.post("EngRiskFrontManagement/importDestruction", {
                ...
                if (jsonStr) {
                    ...
                    var targetId = window.sessionStorage.getItem(window.eqSelTrenderPlanSeq);
                    formData.append("engRiskSeq", this.subProject.EngRiskFrontSeq);
                    var res = (
                        await window.myAjax.post("EngRiskFrontManagement/UploadGeneratedImg",
                            formData,
                            {
                                headers: {
