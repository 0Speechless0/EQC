    ...
    export default {
        ...
        methods: {
            download(item) {
                ...
                window.myAjax.get('/CheckSheet/Chapter5Download?seq=' + item.Seq, { responseType: 'blob' })
                    .then(resp => {
            ...
            getList() {
                ...
                window.myAjax.post('/CheckSheet/Chapter5', params)
                    .then(resp => {
        ...
        async mounted() {
            console.log('mounted() 第五章 材料設備清冊範本');
            this.getList();
        }
    }
</script>
