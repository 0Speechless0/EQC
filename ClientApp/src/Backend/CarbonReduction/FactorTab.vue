        ...
        <tbody>
            <tr v-for="(item, index) in store.items" v-bind:key="item.Seq">
                ...
                <template v-if="item.Seq == store.editSeq">
                    ...
                    <td><input v-model.trim="store.editRecord[`KgCo2e`]" maxlength="20" type="number" class="form-control"></td>
            ...
            <tr>
                ...
                <td><input v-model.trim="store.newItem[`KgCo2e`]" maxlength="20" type="number" class="form-control"></td>
