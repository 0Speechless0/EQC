            ...
            <table class="table table3 min910" border="0">
                ...
                <tbody>
                    ...
                    <tr name="tmpRow" style="display: none;">
                        <td colspan="5" style="background: #f4f5f6;"><qcBase6  v-bind:op1="QCSseq" :op2="QCSopenclose"></qcBase6></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            {
                let {data} = await window.myAjax.post("FlowChartTp/getFlowChartTpDiagramJson", {id: item.Seq, type:"Chapter6"});
            ...
            upload() {
                ...
                window.myAjax.post('/FlowChartTp/Chapter6Upload', files,
                    {
                        headers: {
            ...
            download(item) {
                ...
                window.myAjax.get('/FlowChartTp_TestWeb/Chapter6Download?seq=' + item.Seq, { responseType: 'blob' })
                    .then(resp => {
            ...
            Cekdownload(item) {
                this.Wordphoto = '';
                window.myAjax.post('/FlowChartTp_TestWeb/Chapter6ShowWord', { seq: item.Seq })
                    .then(resp => {
            ...
            getList() {
                ...
                window.myAjax.post('/FlowChartTp_TestWeb/Chapter6', params)
                    .then(resp => {
            ...
            showPicture(item) {
                window.myAjax.post('/FlowChartTp_TestWeb/Chapter6Show', { seq: item.Seq })
                    .then(resp => {
                        if (resp.data.url != null) {
                            console.log(resp.data.url);
