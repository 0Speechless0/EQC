            ...
            <table class="table table3 min910" border="0">
                ...
                <tbody>
                    ...
                    <tr name="tmpRow" style="display: none;">
                        <td colspan="5" style="background: #f4f5f6;"><qcBase702  v-bind:op1="QCSseq" :op2="QCSopenclose"></qcBase702></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            {
                let {data} = await window.myAjax.post("FlowChartTp/getFlowChartTpDiagramJson", {id: item.Seq, type:"Chapter702"});
            ...
            upload() {
                ...
                window.myAjax.post('/FlowChartTp_TestWeb/Chapter702Upload', files,
                    {
                        headers: {
            ...
            download(item) {
                window.myAjax.get('/FlowChartTp_TestWeb/Chapter702Download?seq=' + item.Seq, { responseType: 'blob' })
                    .then(resp => {
            ...
            Cekdownload(item) {
                this.Wordphoto = '';
                window.myAjax.post('/FlowChartTp_TestWeb/Chapter702ShowWord', { seq: item.Seq })
                    .then(resp => {
            ...
            getList() {
                ...
                window.myAjax.post('/FlowChartTp_TestWeb/Chapter702', params)
                    .then(resp => {
            ...
            showPicture(item) {
                window.myAjax.post('/FlowChartTp_TestWeb/Chapter702Show', { seq: item.Seq })
                    .then(resp => {
                        if (resp.data.url != null) {
                            console.log(resp.data.url);
