<template>
<div>
    <h5>{{ subProjectMain.SubProjectName }}</h5>
        ...
        <table border="1" class="table table1 min910" style="border-color: #fff;">
            <tbody>
                <tr>
                    ...
                    <td
                        style="text-align: center;vertical-align:middle;background-color: #dbdbdb;width: 5%;border-bottom-color: #fff;">
                        <p>風險評量</p>
                    </td>
                    <td style="text-align: center;vertical-align:middle;background-color: #dbdbdb;border-bottom-color: #fff;"
                        colspan="4">
                ...
                <tr>
                    <td
                        style="text-align: center;vertical-align:middle;background-color: #dbdbdb;">
                        <p>處理風險與機會之措施</p>
                    </td>
...
export default {
    ...
    methods:
    {
        ...
        {
            let res = (await window.myAjax.post("RiskManagement/updateEngRiskSubProjectDetail", {
        ...
        async getRiskSubProjectDeatil()
        {
            ...
            console.log(this.subProjectMain );
             var subProjectDetailData = (
                await window.myAjax.post("RiskManagement/getEngRiskSubProjectDetail", 
