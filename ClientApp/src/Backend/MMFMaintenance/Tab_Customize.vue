<template>
    <div>
        <h5 style="margin: inherit;">自定義維護功能</h5><p></p>
...
<script>
    export default {
        ...
        methods: {
            //下載碳排表
            download() {
                window.myAjax.get('/MMFMaintenance/dnCustomize', { responseType: 'blob' })
                    .then(resp => {
            ...
            upload(uploadfiles) {
                window.myAjax.post('/MMFMaintenance/CustomizeUpload', uploadfiles,
                    {
