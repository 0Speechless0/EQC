...
export default {
    ...
    methods: {
        ...
        upload(seq, file) {
            ...
            window.myAjax.post('/FlowChartTp/Chapter703Upload', this.files,
                {
                    headers: {
        ...
        download(Seq) {
            ...
            window.myAjax.get('/FlowChartTp/Chapter703Download?seq=' + Seq, { responseType: 'blob' })
                .then(resp => {
        ...
        getList() {
            ...
            window.myAjax.post('/FlowChartTp/Chapter703', params)
                .then(resp => {
        ...
        showPicture(item) {
            window.myAjax.post('/FlowChartTp/Chapter703Show', { seq: item.Seq })
                .then(resp => {
