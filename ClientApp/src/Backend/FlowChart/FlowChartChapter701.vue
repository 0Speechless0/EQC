...
export default {
    ...
    methods: {
        ...
        upload(seq, file) {
            ...
            window.myAjax.post('/FlowChartTp/Chapter701Upload', this.files,
                {
                    headers: {
        ...
        download(Seq) {
            ...
            window.myAjax.get('/FlowChartTp/Chapter701Download?seq=' + Seq, { responseType: 'blob' })
                .then(resp => {
        ...
        getList() {
            ...
            window.myAjax.post('/FlowChartTp/Chapter701', params)
                .then(resp => {
        ...
        showPicture(item) {
            window.myAjax.post('/FlowChartTp/Chapter701Show', { seq: item.Seq })
                .then(resp => {
