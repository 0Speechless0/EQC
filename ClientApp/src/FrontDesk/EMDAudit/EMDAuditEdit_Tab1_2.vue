            ...
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h2 v-if="targetItem.edit">型錄上傳</h2>
    ...
    export default {
        ...
        methods: {
            ...
            getUploadAuditFileList() {
                this.targetItems = [];
                window.myAjax.post('/EMDAudit/GetUploadAuditFileList', { seq: this.targetItem.Seq, fileType: 1 })
                    .then(resp => {
